...
CONFIGURE_SERVICE() {
    ...
    sed -i -e 's/MONGO_DNSNAME/172.31.28.211/' -e 's/REDIS_ENDPOINT/172.31.80.33/' -e 's/CATALOGUE_ENDPOINT/172.31.18.22/' /home/roboshop/$COMPONENT systemd.service &>> $LOGFILE
